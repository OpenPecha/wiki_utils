...
from wiki_utils.wikisource.utils import download_links_and_make_csv

# Initialize the logger
logger = get_logger(__name__)


SITE_CODE = "mul"  # 'mul' is for multilingual
...
def get_page_titles(
    ...
    """
    # Set cache_dir inside the wikisource folder
...
if __name__ == "__main__":
    ...
    * You can do in continuation as well but recommended is always check first
    ...
    creds_path = BASE_DIR / "my-credentials.json"
    range_rows = "སྤྱོད་འཇུག་གི་ལས་གཞི།!G3:K8"
    output_csv = BASE_DIR / "data" / "work_list.csv"
    download_dir = BASE_DIR / "data" / "text"

    # download_links_and_make_csv(sheet_id, creds_path, range_rows, output_csv, download_dir)
