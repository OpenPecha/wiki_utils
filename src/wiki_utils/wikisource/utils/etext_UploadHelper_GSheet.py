...
def get_wikisource_index_from_url(url):
    """
...
def download_drive_file_with_name(drive_service, file_id, download_dir):
    """
...
def download_google_doc_with_name(drive_service, doc_url, download_dir):
    """
    ...
    match = re.match(r"https://docs.google.com/document/d/([a-zA-Z0-9_-]+)", doc_url)
    if not match:
